     ...
     <section className='bg-slate-200 py-12  px-4 md:flex xl:px-40 xl:py-20'>
       ...
       <div className='mt-10 leading-8'> 
        <FontAwesomeIcon icon={faLocationDot} size="lg" /> 
            ...
            <div className='mt-2'><FaWhatsapp className='inline text-xl' /><span className='ml-2 font-semibold text-2xl '>+971 562678637</span></div>
      </div>
      <div className=' bg-white  py-10 px-8 pb-16 md:basis-1/2' data-aos="fade-up" data-aos-duration="1000">
       ...
       <div className='my-8 leading-10'>
         <input className='border-b-2 w-full mt-6 pb-5 focus:outline-none' type="text" placeholder='Name' ></input>
        <input className='border-b-2 w-full mt-6 pb-5 focus:outline-none' type="text" placeholder='Message'></input> </div>
        <div className='md:text-center'><button className='px-4 border-2 py-3 rounded-lg bg-black text-slate-100 font-semibold '>SEND US A MESSAGE</button></div>
      </div>
      </section>

      {/* <section class=''> */}
        <div className='w-full lg:pb-10 bg-slate-200'>
        <iframe className='w-full ' src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3596.3697636078514!2d55.79474747490547!3d25.659034612840834!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ef5e113568e5445%3A0xcd8bdea54063ce91!2sAMK%20Copiers%20FZ-LLC!5e0!3m2!1sen!2sae!4v1711971186257!5m2!1sen!2sae" 
      width="600"
       height="450" 
      //  style="border:0;" 
       allowfullscreen="" 
