...
const Servicespage = () => {
  return (
    <div>
      ...
      <img src={serviceparts} className='h-72 sm:w-full md:h-96 lg:h-[32rem] xl:h-[36rem]'></img>
      ...
      <div className='pb-20 grid p-8 gap-8 md:grid-cols-2 xl:grid-cols-3 xl:px-12 '>
        <img src={gallery_1} className='h-96 w-full md:h-96 xl:h-[32rem]' data-aos="fade-up" data-aos-duration="2000"></img>
        <img src={gallery_2} className='h-96 w-full md:h-96 xl:h-[32rem]' data-aos="fade-up" data-aos-duration="1500"></img>
        <img src={gallery_3} className='h-96 w-full md:h-96 xl:h-[32rem]' data-aos="fade-up" data-aos-duration="1000"></img>
        <img src={gallery_4} className='h-96 w-full md:h-96 xl:h-[32rem]' data-aos="fade-up" data-aos-duration="2000"></img>
        <img src={gallery_5} className='h-96 w-full md:h-96 xl:h-[32rem]' data-aos="fade-up" data-aos-duration="1500"></img>
        {/* <img src={gallery_6} className='h-96 w-full '></img> */}
        <img src={gallery_7} className='h-96 w-full md:h-96 xl:h-[32rem]' data-aos="fade-up" data-aos-duration="1000"></img>
      </div>
      </div>
      <Footer />
    </div>
