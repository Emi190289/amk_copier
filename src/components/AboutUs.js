...
const AboutUs = () => {
  return (
    <div>
        <Header/>
        <Menu/>
        <div class=' xl:h-[36rem]' ><img src={main} className='sm:w-full sm:h-72 md:h-[32rem] lg:h-[40rem] xl:h-full '></img></div>
        ...
        <section className='bg-slate-100 lg:pb-10' >
          <div className=' p-4 md:flex lg:px-24 xl:px-60'>  
            <div className='sm:ml-20 md:m-0 md:basis-1/2' data-aos="fade-right" data-aos-duration="1000"><img class='sm:h-96 sm:w-96 ' src={aboutus} alt="About Us"></img>  </div>
