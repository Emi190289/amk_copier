...
const Noncontractpage = () => {
  return (
    <div>
      ...
      <Menu />
      <div className=''>
        <img class='sm:w-full md:h-96 lg:h-[32rem] xl:h-[36rem]' src={noncontractpage}></img>
    ...
    <div class='md:flex xl:px-28 '> 
     <div class='bg-slate-100 pb-3 p-4 md:basis-1/2 lg:pb-16 ' data-aos="fade-up" data-aos-duration="1000"> 
       <p className='text-2xl font-bold  pt-8 '>Our Non-contract Services Include The Following:</p>
        ...
        <div class='bg-slate-100 p-4 md:basis-1/2 md:pt-16' data-aos="fade-left" data-aos-easing="ease-in-sine">
          <img class='rounded  sm:h-80 sm:w-screen md:h-96 lg:h-96 xl:w-full' src={noncontractpage1}></img>
          </div>
        </div>
