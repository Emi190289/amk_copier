...
const Noncontract = () => {
  ...
  return (
    <section className='bg-slate-100 pb-8 p-4  lg:flex xl:px-24'>
       <div className='lg:basis-1/2' data-aos="fade-up" data-aos-duration="1000"><p className='text-3xl font-bold text-center pt-10'>Non Contract Services</p>
        <div className='mt-10 '> <p>AMK Copier offers our customers several options for servicing and maintaining 
      ...
      <div className='mt-4 pl-6 '> 
       <button className='bg-[#039700] border-2 px-4 py-2 rounded-md text-slate-100' onClick={handleclick}>Read More</button></div></div>
      </div> 
        <div className=' mt-10   lg:mt-14 lg:inline lg:basis-1/2 xl:h-full' data-aos="fade-right" data-aos-duration="1000" > 
            <img src={noncontract} className='md:h-96 md:w-full lg:h-96 lg:px-6 xl:pl-10 xl:pr-4 xl:h-full '></img>
        </div>
    </section>
  )
}
